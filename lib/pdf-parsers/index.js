...
export function detectarBanco(texto) {
  ...
  // PicPay — usa keywords mais específicas para evitar match com "PICPAY*" em merchant names
  // "PICPAY SERVICOS" e "PIC PAY" são específicos de faturas PicPay.
  // "PICPAY" genérico é mantido mas só chega aqui se C6/Santander/etc não matcharam antes.
