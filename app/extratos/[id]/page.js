...
const CATEGORY_COLORS = {
  ...
  'Aporte Sócio': 'bg-emerald-50 text-emerald-700',
  'Pró-labore': 'bg-pink-50 text-pink-700',
  'Funcionários': 'bg-violet-50 text-violet-700',
  'Impostos': 'bg-rose-50 text-rose-700',
  'Fretes': 'bg-cyan-50 text-cyan-700',
  'Contabilidade': 'bg-purple-50 text-purple-700',
  'Câmbio': 'bg-green-50 text-green-700',
  'Taxas/Checkout': 'bg-yellow-50 text-yellow-700',
  'Transferência Interna': 'bg-slate-50 text-slate-700',
  'Rendimentos': 'bg-cyan-50 text-cyan-700',
  'Pagamentos': 'bg-orange-50 text-orange-700',
